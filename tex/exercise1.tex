...
Since these both increase \delO{SW}, their effects can be distinguished using the temperature record. 

% In accordance with \parencite{thornalley2011reconstructing}, the drop in \delO{SW} over HS1 can be interpreted to reflect an increase in local brine formation,  
